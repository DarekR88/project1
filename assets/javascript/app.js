   ...
   $.ajax({
      ...
      $.ajax({
         ...
         for (var i = 0; i < zipResponse.DailyForecasts.length; i++) {
            ...
            $("#forecast").append("<div><p>Date: " + moment(date).format("LLLL") + "</p></div><div><p>Condition: " + condition + "</p></div><div><p>High Temperature: " + highTemp + " F</p></div><div><p>Low Temperature: " + lowTemp + " F</p></div>")
         };
      });
